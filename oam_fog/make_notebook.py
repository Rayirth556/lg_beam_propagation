"""Run this once: python make_notebook.py  — creates oamnet_colab.ipynb"""
import json

def cell(source_lines, kind="code"):
    if kind == "markdown":
...
cells = [
    ...
    # Cell 3: Loss / train / eval functions
    cell([
...
with open("oamnet_colab.ipynb", "w", encoding="utf-8") as f:
    json.dump(nb, f, indent=1, ensure_ascii=False)

print("oamnet_colab.ipynb written successfully.")
